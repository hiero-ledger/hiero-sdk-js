...
/**
 * @typedef {IRegisteredNodeCreateTransactionBody & { nodeAccountId?: import("@hiero-ledger/proto").proto.IAccountID | null }} IRegisteredNodeCreateTransactionBodyWithNodeAccountId
 */
...
export default class RegisteredNodeCreateTransaction extends Transaction {
    ...
    _makeTransactionData() {
        /** @type {IRegisteredNodeCreateTransactionBodyWithNodeAccountId} */
        const data = {
            adminKey:
