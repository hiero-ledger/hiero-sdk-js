...
/**
 * @typedef {IRegisteredNodeUpdateTransactionBody & { nodeAccountId?: import("@hiero-ledger/proto").proto.IAccountID | null }} IRegisteredNodeUpdateTransactionBodyWithNodeAccountId
 */
...
export default class RegisteredNodeUpdateTransaction extends Transaction {
                ...
                nodeAccountId:
                    maybeNodeAccountId.nodeAccountId != null
                        ? AccountId._fromProtobuf(
                              maybeNodeAccountId.nodeAccountId,
                          )
                        : undefined,
                serviceEndpoints:
    ...
    /**
     * @param {AccountId | string} nodeAccountId
     * @returns {RegisteredNodeUpdateTransaction}
     */
    setNodeAccountId(nodeAccountId) {
        this._requireNotFrozen();
        this._nodeAccountId =
            nodeAccountId instanceof AccountId
                ? nodeAccountId
    ...
    _makeTransactionData() {
        /** @type {IRegisteredNodeUpdateTransactionBodyWithNodeAccountId} */
        const data = {
            registeredNodeId:
        ...
        if (this._nodeAccountId != null) {
            data.nodeAccountId = this._nodeAccountId._toProtobuf();
        }
