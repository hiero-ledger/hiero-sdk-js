...
export default class EthereumAuthorization {
    ...
    constructor(chainId, address, nonce, yParity, r, s) {
        /** @type {Uint8Array} */
        this._chainId = toMinimalBytes(chainId);
        /** @type {Uint8Array} */
        this._address =
        ...
        /** @type {Uint8Array} */
        this._nonce = toMinimalBytes(nonce);
        /** @type {Uint8Array} */
        this._yParity = toMinimalBytes(yParity);
        /** @type {Uint8Array} */
        this._r = bytesOrHexToBytes(r);
        /** @type {Uint8Array} */
        this._s = bytesOrHexToBytes(s);
    }
     ...
     */
    getChainId() {
        return bytesToLong(this._chainId);
    }
     ...
     */
    getNonce() {
        return bytesToLong(this._nonce);
    }
     ...
     */
    getYParity() {
        return bytesToLong(this._yParity);
    }
