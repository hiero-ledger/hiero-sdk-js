...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token claim airdrop.
    ...
    proto.TokenClaimAirdropTransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc Token claim airdrop - complete pending transfers for an airdrop.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenClaimAirdropTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for token claim airdrop.
         ...
         * @member {"tokenClaimAirdrop"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenClaimAirdrop"]),
