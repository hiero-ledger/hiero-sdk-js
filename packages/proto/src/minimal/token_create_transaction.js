...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token creation.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for token creation.
         ...
         * @member {"tokenCreation"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenCreation"]),
    ...
    proto.TokenCreateTransactionBody = (function() {
         ...
         * @property {string|null} [name] The publicly visible name of the token.
         * @property {string|null} [symbol] The publicly visible token symbol.
         * @property {number|null} [decimals] The number of decimal places a token is divisible by.
         * @property {Long|null} [initialSupply] Specifies the initial supply of tokens to be put in circulation.
         * @property {proto.IAccountID|null} [treasury] The account which will act as a treasury for the token.
         * @property {proto.IKey|null} [adminKey] The key which can perform update/delete operations on the token.
         * @property {proto.IKey|null} [kycKey] The key which can grant or revoke KYC of an account for the token's transactions.
         * @property {proto.IKey|null} [freezeKey] The key which can sign to freeze or unfreeze an account for token transactions.
         * @property {proto.IKey|null} [wipeKey] The key which can wipe the token balance of an account.
         * @property {proto.IKey|null} [supplyKey] The key which can change the supply of a token.
         * @property {boolean|null} [freezeDefault] The default Freeze status (frozen or unfrozen) of Hedera accounts relative to this token.
         * @property {proto.ITimestamp|null} [expiry] The epoch second at which the token should expire.
         * @property {proto.IAccountID|null} [autoRenewAccount] An account which will be automatically charged to renew the token's expiration.
         ...
         * @property {proto.TokenType|null} [tokenType] IWA compatibility. Specifies the token type.
         * @property {proto.TokenSupplyType|null} [supplyType] IWA compatibility. Specified the supply type of the token.
         * @property {Long|null} [maxSupply] IWA Compatibility. Depends on TokenSupplyType.
         * @property {proto.IKey|null} [feeScheduleKey] The key which can change the token's custom fee schedule.
         ...
         * @property {Uint8Array|null} [metadata] Metadata that is passed through and not validated.
         * @property {proto.IKey|null} [metadataKey] The key which can update the metadata of a token.
         */
