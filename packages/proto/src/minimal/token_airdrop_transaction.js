...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token airdrop.
    ...
    proto.TokenAirdropTransactionBody = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenAirdropTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenAirdropTransactionBody|null} [tokenAirdrop] Airdrop tokens.
         ...
         * @memberof proto
         * @classdesc A transaction body for token airdrop.
         ...
         * @member {"tokenAirdrop"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenAirdrop"]),
