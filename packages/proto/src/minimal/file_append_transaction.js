...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for file append.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for file append.
         ...
         * @member {"fileAppend"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["fileAppend"]),
    ...
    proto.FileAppendTransactionBody = (function() {
         ...
         * @property {proto.IFileID|null} [fileID] The file ID to append to.
         * @property {Uint8Array|null} [contents] The bytes to append to the contents of the file.
         */

        /**
         * Constructs a new FileAppendTransactionBody.
         * @memberof proto
         * @classdesc Append the given contents to the end of the specified file.
