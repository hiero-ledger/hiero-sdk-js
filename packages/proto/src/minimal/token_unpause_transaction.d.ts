...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for token unpausing. */
        ...
        /** A transaction body for token unpausing. */
        ...
        /** Unpauses the Token from being paused. */
