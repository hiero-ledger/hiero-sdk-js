...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token association.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for token association.
         ...
         * @member {"tokenAssociate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenAssociate"]),
    ...
    proto.TokenAssociateTransactionBody = (function() {
         ...
         * @property {Array.<proto.ITokenID>|null} [tokens] The tokens to be associated with the provided account.
         */

        /**
         * Constructs a new TokenAssociateTransactionBody.
         * @memberof proto
         * @classdesc Associates the provided account with the provided tokens.
