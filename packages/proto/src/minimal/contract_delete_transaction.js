...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for contract deletion.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.IContractDeleteTransactionBody|null} [contractDeleteInstance] Delete a smart contract and transfer remaining balance to a specified account.
         ...
         * @memberof proto
         * @classdesc A transaction body for contract deletion.
         ...
         * @member {"contractDeleteInstance"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["contractDeleteInstance"]),
        ...
        TransactionBody.encode = function encode(m, w) {
            ...
            if (m.contractDeleteInstance != null && Object.hasOwnProperty.call(m, "contractDeleteInstance"))
                $root.proto.ContractDeleteTransactionBody.encode(m.contractDeleteInstance, w.uint32(82).fork()).ldelim();
    ...
    proto.ContractDeleteTransactionBody = (function() {
         ...
         * @property {proto.IContractID|null} [contractID] The contract to delete.
         * @property {proto.IAccountID|null} [transferAccountID] The account to receive any remaining hbars from the deleted contract.
         * @property {proto.IContractID|null} [transferContractID] The contract to receive any remaining hbars from the deleted contract.
         * @property {boolean|null} [permanentRemoval] If set to true, means this is a permanent deletion (versus an expiration).
         */

        /**
         * Constructs a new ContractDeleteTransactionBody.
         * @memberof proto
         * @classdesc Mark a smart contract as deleted, and transfer its remaining hbars to another account.
        ...
        /**
         * The account to receive any remaining hbars from the deleted contract.
        ...
        /**
         * The contract to receive any remaining hbars from the deleted contract.
        ...
        /**
         * If set to true, means this is a permanent deletion (versus an expiration).
