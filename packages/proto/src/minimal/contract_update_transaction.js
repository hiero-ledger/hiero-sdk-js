...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for contract updates.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for contract updates.
         ...
         * @member {"contractUpdateInstance"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["contractUpdateInstance"]),
    ...
    proto.ContractUpdateTransactionBody = (function() {
         ...
         * @property {proto.IContractID|null} [contractID] The Contract ID of the contract to update.
         * @property {proto.ITimestamp|null} [expirationTime] The expiration time to extend to (the amount to extend the current expiration time).
         * @property {proto.IKey|null} [adminKey] The new admin key for this contract.
         * @property {proto.IAccountID|null} [proxyAccountID] An account that is charged for auto-renewal of this contract.
         * @property {proto.IDuration|null} [autoRenewPeriod] The auto renew period for this contract.
         * @property {proto.IFileID|null} [fileID] The new file ID of the bytecode to update the contract with.
         * @property {string|null} [memo] The new contract memo, assumed to be Unicode encoded with UTF-8.
         * @property {number|null} [maxAutomaticTokenAssociations] The maximum number of tokens that this contract can be automatically associated with.
         * @property {proto.IAccountID|null} [autoRenewAccountId] An account to charge for auto-renewal of this contract.
         ...
         * @property {boolean|null} [declineReward] If set to the sentinel value of -1, then this contract declines receiving a staking reward.
         */

        /**
         * Constructs a new ContractUpdateTransactionBody.
         * @memberof proto
         * @classdesc Modify a smart contract.
        ...
        /**
         * The Contract ID of the contract to update.
        ...
        /**
         * The expiration time to extend to (the amount to extend the current expiration time).
        ...
        /**
         * The new admin key for this contract.
        ...
        /**
         * An account that is charged for auto-renewal of this contract.
        ...
        /**
         * The auto renew period for this contract.
        ...
        /**
         * The new file ID of the bytecode to update the contract with.
        ...
        /**
         * The new contract memo, assumed to be Unicode encoded with UTF-8.
         * @member {string} memo
         * @memberof proto.ContractUpdateTransactionBody
         * @instance
         */
         ...
         * @instance
         */
        ContractUpdateTransactionBody.prototype.maxAutomaticTokenAssociations = 0;
         ...
         * @instance
         */
        ContractUpdateTransactionBody.prototype.declineReward = false;
        ...
        ContractUpdateTransactionBody.encode = function encode(m, w) {
            ...
            if (m.autoRenewAccountId != null && Object.hasOwnProperty.call(m, "autoRenewAccountId"))
                $root.proto.AccountID.encode(m.autoRenewAccountId, w.uint32(90).fork()).ldelim();
            if (m.stakedAccountId != null && Object.hasOwnProperty.call(m, "stakedAccountId"))
                $root.proto.AccountID.encode(m.stakedAccountId, w.uint32(98).fork()).ldelim();
            if (m.stakedNodeId != null && Object.hasOwnProperty.call(m, "stakedNodeId"))
                w.uint32(104).int64(m.stakedNodeId);
            if (m.declineReward != null && Object.hasOwnProperty.call(m, "declineReward"))
                w.uint32(112).bool(m.declineReward);
            return w;
        };
