...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for node create.
    ...
    proto.NodeCreateTransactionBody = (function() {
         ...
         * @property {boolean|null} [declineReward] A boolean flag indicating whether the node operator declines to receive node rewards.
         ...
         * @constructor
         * @param {proto.INodeCreateTransactionBody=} [p] Properties to set
         */
         ...
         * @memberof proto.NodeCreateTransactionBody
         * @instance
         */
         ...
         * @memberof proto.NodeCreateTransactionBody
         * @static
         * @param {proto.INodeCreateTransactionBody=} [properties] Properties to set
         * @returns {proto.NodeCreateTransactionBody} NodeCreateTransactionBody instance
         */
        ...
        /**
         * Encodes the specified NodeCreateTransactionBody message. Does not implicitly {@link proto.NodeCreateTransactionBody.verify|verify} messages.
         * @function encode
         * @memberof proto.NodeCreateTransactionBody
         * @static
         * @param {proto.INodeCreateTransactionBody} m NodeCreateTransactionBody message or plain object to encode
         * @param {$protobuf.Writer} [w] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {proto.NodeCreateTransactionBody} NodeCreateTransactionBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NodeCreateTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.proto.NodeCreateTransactionBody();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        NodeCreateTransactionBody.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.NodeCreateTransactionBody";
        };
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.INodeCreateTransactionBody|null} [nodeCreate] Create a new node in the network address book.
         ...
         * @memberof proto
         * @classdesc A transaction body for node create.
         ...
         * @member {proto.INodeCreateTransactionBody|null|undefined} nodeCreate
         * @memberof proto.TransactionBody
         * @instance
         */
         ...
         * @member {"nodeCreate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["nodeCreate"]),
        ...
        TransactionBody.encode = function encode(m, w) {
            ...
            if (m.nodeCreate != null && Object.hasOwnProperty.call(m, "nodeCreate"))
                $root.proto.NodeCreateTransactionBody.encode(m.nodeCreate, w.uint32(434).fork()).ldelim();
        ...
        TransactionBody.decode = function decode(r, l) {
            ...
            while (r.pos < c) {
                ...
                case 54: {
                        m.nodeCreate = $root.proto.NodeCreateTransactionBody.decode(r, r.uint32());
                        break;
                    }
                case 1001: {
