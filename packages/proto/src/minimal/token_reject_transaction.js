...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token reject.
    ...
    proto.TokenReference = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenReference.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
    ...
    proto.TokenRejectTransactionBody = (function() {
         ...
         * @property {proto.IAccountID|null} [owner] An account identifier.
         ...
         * @memberof proto
         * @classdesc Reject undesired token(s).
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenRejectTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenRejectTransactionBody|null} [tokenReject] Reject and return a token to treasury.
         ...
         * @memberof proto
         * @classdesc A transaction body for token reject.
         ...
         * @member {"tokenReject"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenReject"]),
            set: $util.oneOfSetter($oneOfFields)
        });
