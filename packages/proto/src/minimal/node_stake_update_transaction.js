...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for node stake update.
    ...
    proto.NodeStake = (function() {
         ...
         * @property {Long|null} [rewardRate] The rate of rewards, in tinybar per HBAR.
    ...
    proto.NodeStakeUpdateTransactionBody = (function() {
         ...
         * @property {Array.<proto.INodeStake>|null} [nodeStake] A list of NodeStake entries for each node.
         * @property {Long|null} [maxStakingRewardRatePerHbar] A maximum reward rate for this staking period.
         * @property {proto.IFraction|null} [nodeRewardFeeFraction] A fraction of network and service fees paid to the node reward account.
         * @property {Long|null} [stakingPeriodsStored] A limit to the number of staking periods held for inactive accounts.
         * @property {Long|null} [stakingPeriod] A number of minutes representing a staking period.
         * @property {proto.IFraction|null} [stakingRewardFeeFraction] A fraction of network and service fees paid to the general reward account.
         * @property {Long|null} [stakingStartThreshold] A minimum balance required to pay general staking rewards.
         * @property {Long|null} [reservedStakingRewards] An amount reserved in the staking reward account.
         * @property {Long|null} [unreservedStakingRewardBalance] An available, unreserved, amount in the staking reward account.
         * @property {Long|null} [rewardBalanceThreshold] A minimum balance required for maximum staking rewards.
         * @property {Long|null} [maxStakeRewarded] A maximum network-wide stake that can earn full rewards.
         * @property {Long|null} [maxTotalReward] A limit amount that could be paid as staking rewards.
         */
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.INodeStakeUpdateTransactionBody|null} [nodeStakeUpdate] Update the staking information.
         ...
         * @memberof proto
         * @classdesc A transaction body for node stake update.
         ...
         * @member {"nodeStakeUpdate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["nodeStakeUpdate"]),
