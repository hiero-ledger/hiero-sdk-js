...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for token fee schedule update. */
        ...
        /** A transaction body for token fee schedule update. */
        class TransactionBody implements ITransactionBody {
            ...
            public data?: "tokenFeeScheduleUpdate";
