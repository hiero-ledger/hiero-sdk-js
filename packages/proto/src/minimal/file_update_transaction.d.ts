...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for file updates. */
        ...
        /** A transaction body for file updates. */
        ...
        /** Modify the metadata and/or contents of a file. */
