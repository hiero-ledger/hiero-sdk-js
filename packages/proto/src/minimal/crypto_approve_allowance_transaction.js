...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for crypto allowance approval.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ICryptoApproveAllowanceTransactionBody|null} [cryptoApproveAllowance] Add one or more approved allowances for spenders.
         ...
         * @memberof proto
         * @classdesc A transaction body for crypto allowance approval.
        ...
        /**
         * Add one or more approved allowances for spenders.
         ...
         * @member {"cryptoApproveAllowance"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["cryptoApproveAllowance"]),
    ...
    proto.CryptoApproveAllowanceTransactionBody = (function() {
         ...
         * @property {Array.<proto.INftAllowance>|null} [nftAllowances] List of NFT allowances approved by the account owner.
         ...
         * @memberof proto
         * @classdesc Creates one or more hbar/token approved allowances.
    ...
    proto.CryptoAllowance = (function() {
         ...
         * @property {proto.IAccountID|null} [owner] The account that owns the hbar.
         * @property {proto.IAccountID|null} [spender] The account authorized to spend the hbar.
         * @property {Long|null} [amount] The amount of hbar authorized to be spent by the spender.
         */
    ...
    proto.NftAllowance = (function() {
         ...
         * @property {proto.IAccountID|null} [owner] The account that owns the NFT.
         * @property {proto.IAccountID|null} [spender] The account authorized to spend the NFT.
         * @property {proto.ITokenID|null} [tokenId] The token that the allowance pertains to.
         * @property {Array.<Long>|null} [serialNumbers] List of serial numbers that the spender is authorized to transfer.
         * @property {boolean|null} [approvedForAll] If true, the spender has access to all of the owner's NFT units.
         * @property {proto.IAccountID|null} [delegatingSpender] The account that should be charged the fee for the current allowance.
         */

        /**
         * Constructs a new NftAllowance.
         * @memberof proto
         * @classdesc An approved allowance of NFT transfers for a spender.
         ...
         * @member {boolean} approvedForAll
         * @memberof proto.NftAllowance
         * @instance
         */
        NftAllowance.prototype.approvedForAll = false;
        ...
        NftAllowance.encode = function encode(m, w) {
            ...
            if (m.tokenId != null && Object.hasOwnProperty.call(m, "tokenId"))
                $root.proto.TokenID.encode(m.tokenId, w.uint32(26).fork()).ldelim();
            ...
            if (m.approvedForAll != null && Object.hasOwnProperty.call(m, "approvedForAll"))
                w.uint32(40).bool(m.approvedForAll);
    ...
    proto.TokenAllowance = (function() {
         ...
         * @property {proto.IAccountID|null} [owner] The account that owns the tokens.
         * @property {proto.IAccountID|null} [spender] The account authorized to spend the tokens.
         * @property {Long|null} [amount] The amount of tokens that the spender is authorized to spend.
         * @property {proto.ITokenID|null} [tokenId] The token that the allowance pertains to.
         */
        ...
        TokenAllowance.encode = function encode(m, w) {
            ...
            if (m.amount != null && Object.hasOwnProperty.call(m, "amount"))
                w.uint32(24).int64(m.amount);
            if (m.tokenId != null && Object.hasOwnProperty.call(m, "tokenId"))
                $root.proto.TokenID.encode(m.tokenId, w.uint32(34).fork()).ldelim();
            return w;
        };
