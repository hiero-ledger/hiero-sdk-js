...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @property {proto.ITransactionBody|null} [body] Replaced with `signedTransactionBytes`.
         * The body of the transaction.
         * @property {proto.ISignatureList|null} [sigs] Replaced with `signedTransactionBytes`.
         * The signatures on the body.
         * @property {proto.ISignatureMap|null} [sigMap] Replaced with `signedTransactionBytes`.
         * The signatures on the body with a newer format.
         * @property {Uint8Array|null} [bodyBytes] Replaced with `signedTransactionBytes`.
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for crypto account creation.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {boolean|null} [generateRecord] Records are always generated.
         ...
         * @memberof proto
         * @classdesc A transaction body for crypto account creation.
         ...
         * @member {"cryptoCreateAccount"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["cryptoCreateAccount"]),
