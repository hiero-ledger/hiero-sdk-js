...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for consensus topic deletion.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for consensus topic deletion.
         ...
         * @member {"consensusDeleteTopic"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
