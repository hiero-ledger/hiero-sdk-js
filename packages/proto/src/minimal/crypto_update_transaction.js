...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for crypto account updates.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for crypto account updates.
         ...
         * @member {"cryptoUpdateAccount"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["cryptoUpdateAccount"]),
    ...
    proto.CryptoUpdateTransactionBody = (function() {
         ...
         * @property {proto.IAccountID|null} [accountIDToUpdate] The account ID to update.
         * @property {proto.IKey|null} [key] The new key for the account.
         * @property {proto.IAccountID|null} [proxyAccountID] Use staked_id instead.
         * @property {proto.ITimestamp|null} [expirationTime] The new expiry time for the account.
         * @property {proto.IDuration|null} [autoRenewPeriod] The new period that the account will be charged.
         * @property {boolean|null} [receiverSigRequiredWrapper] If set to the sentinel value of 0.0.0, this field removes the account's receiver signature requirement.
         * @property {string|null} [memo] If set, the new memo to be associated with the account.
         * @property {number|null} [maxAutomaticTokenAssociations] The maximum number of tokens that this account can be automatically associated with.
         ...
         * @property {boolean|null} [declineReward] If true, the account declines receiving a staking reward.
         */

        /**
         * Constructs a new CryptoUpdateTransactionBody.
         * @memberof proto
         * @classdesc Change properties for the given account.
        ...
        /**
         * The new expiry time for the account.
        ...
        /**
         * The new period that the account will be charged.
        ...
        /**
         * If set to the sentinel value of 0.0.0, this field removes the account's receiver signature requirement.
         * @member {boolean} receiverSigRequiredWrapper
         * @memberof proto.CryptoUpdateTransactionBody
         * @instance
         */
        CryptoUpdateTransactionBody.prototype.receiverSigRequiredWrapper = false;

        /**
         * If set, the new memo to be associated with the account.
         * @member {string} memo
         * @memberof proto.CryptoUpdateTransactionBody
         * @instance
         */
        CryptoUpdateTransactionBody.prototype.memo = "";

        /**
         * The maximum number of tokens that this account can be automatically associated with.
         * @member {number} maxAutomaticTokenAssociations
         * @memberof proto.CryptoUpdateTransactionBody
         * @instance
         */
        CryptoUpdateTransactionBody.prototype.maxAutomaticTokenAssociations = 0;
         ...
         * @instance
         */
        CryptoUpdateTransactionBody.prototype.declineReward = false;
        ...
        CryptoUpdateTransactionBody.encode = function encode(m, w) {
            ...
            if (m.expirationTime != null && Object.hasOwnProperty.call(m, "expirationTime"))
                $root.proto.Timestamp.encode(m.expirationTime, w.uint32(50).fork()).ldelim();
            ...
            if (m.receiverSigRequiredWrapper != null && Object.hasOwnProperty.call(m, "receiverSigRequiredWrapper"))
                w.uint32(64).bool(m.receiverSigRequiredWrapper);
            if (m.memo != null && Object.hasOwnProperty.call(m, "memo"))
        ...
        CryptoUpdateTransactionBody.decode = function decode(r, l) {
            ...
            while (r.pos < c) {
                ...
                case 8: {
                        m.receiverSigRequiredWrapper = r.bool();
                        break;
                    }
                case 9: {
                        m.memo = r.string();
