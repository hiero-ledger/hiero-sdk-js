...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for consensus message submission. */
        ...
        /** A transaction body for consensus message submission. */
        class TransactionBody implements ITransactionBody {
            ...
            public data?: "consensusSubmitMessage";
        ...
        /** Information about a chunk in a fragmented message. */
