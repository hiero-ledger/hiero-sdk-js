...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for crypto allowance approval. */
        ...
        /** A transaction body for crypto allowance approval. */
        class TransactionBody implements ITransactionBody {
            ...
            public data?: "cryptoApproveAllowance";
        ...
        interface INftAllowance {
            ...
            delegatingSpender?: (proto.IAccountID|null);
        }
        ...
        class NftAllowance implements INftAllowance {
            ...
            /** The account that should be charged the fee for the current allowance. */
            public delegatingSpender?: (proto.IAccountID|null);
