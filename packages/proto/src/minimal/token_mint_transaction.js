...
const $root = $protobuf.roots.hashgraph_token_mint_transaction || ($protobuf.roots.hashgraph_token_mint_transaction = {});
...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token minting.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenMintTransactionBody|null} [tokenMint] Mint new tokens.
         ...
         * @memberof proto
         * @classdesc A transaction body for token minting.
         ...
         * @member {"tokenMint"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenMint"]),
    ...
    proto.TokenMintTransactionBody = (function() {
         ...
         * @property {proto.ITokenID|null} [token] The token for which to mint tokens.
         * @property {Long|null} [amount] Applicable to tokens of type FUNGIBLE_COMMON.
         * The amount to mint to the Treasury Account.
         * @property {Array.<Uint8Array>|null} [metadata] Applicable to tokens of type NON_FUNGIBLE_UNIQUE.
         ...
         * @memberof proto
         * @classdesc Mints tokens to the Token's treasury Account.
