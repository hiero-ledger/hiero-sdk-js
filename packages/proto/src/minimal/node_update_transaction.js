...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for node update.
    ...
    proto.StringValue = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper for optional string values.
        ...
        StringValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.StringValue";
        };
    ...
    proto.BoolValue = (function() {
         ...
         * @property {boolean|null} [value] The boolean value.
         */

        /**
         * Constructs a new BoolValue.
         * @memberof proto
         * @classdesc A wrapper for optional boolean values.
        ...
        BoolValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.BoolValue";
        };

        return BoolValue;
    })();

    proto.NodeUpdateTransactionBody = (function() {
         ...
         * @property {proto.IStringValue|null} [description] A short description of the node.
         ...
         * @property {proto.IBoolValue|null} [declineReward] A boolean indicating that this node has chosen to decline node rewards.
         ...
         * @constructor
         * @param {proto.INodeUpdateTransactionBody=} [p] Properties to set
         */
         ...
         * @member {Long} nodeId
         * @memberof proto.NodeUpdateTransactionBody
         * @instance
         */
         ...
         * @member {proto.IStringValue|null|undefined} description
         * @memberof proto.NodeUpdateTransactionBody
         * @instance
         */
         ...
         * @member {proto.IBoolValue|null|undefined} declineReward
         * @memberof proto.NodeUpdateTransactionBody
         * @instance
         */
         ...
         * @memberof proto.NodeUpdateTransactionBody
         * @static
         * @param {proto.INodeUpdateTransactionBody=} [properties] Properties to set
         * @returns {proto.NodeUpdateTransactionBody} NodeUpdateTransactionBody instance
         */
        ...
        /**
         * Encodes the specified NodeUpdateTransactionBody message. Does not implicitly {@link proto.NodeUpdateTransactionBody.verify|verify} messages.
         * @function encode
         * @memberof proto.NodeUpdateTransactionBody
         * @static
         * @param {proto.INodeUpdateTransactionBody} m NodeUpdateTransactionBody message or plain object to encode
         * @param {$protobuf.Writer} [w] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        NodeUpdateTransactionBody.encode = function encode(m, w) {
            ...
            if (m.description != null && Object.hasOwnProperty.call(m, "description"))
                $root.proto.StringValue.encode(m.description, w.uint32(26).fork()).ldelim();
            ...
            if (m.declineReward != null && Object.hasOwnProperty.call(m, "declineReward"))
                $root.proto.BoolValue.encode(m.declineReward, w.uint32(74).fork()).ldelim();
         ...
         * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {proto.NodeUpdateTransactionBody} NodeUpdateTransactionBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NodeUpdateTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.proto.NodeUpdateTransactionBody();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
                ...
                case 3: {
                        m.description = $root.proto.StringValue.decode(r, r.uint32());
                        break;
                    }
                case 4: {
                ...
                case 9: {
                        m.declineReward = $root.proto.BoolValue.decode(r, r.uint32());
                        break;
                    }
                case 10: {
        ...
        NodeUpdateTransactionBody.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.NodeUpdateTransactionBody";
        };
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.INodeUpdateTransactionBody|null} [nodeUpdate] Update a node in the network address book.
         ...
         * @memberof proto
         * @classdesc A transaction body for node update.
         ...
         * @member {proto.INodeUpdateTransactionBody|null|undefined} nodeUpdate
         * @memberof proto.TransactionBody
         * @instance
         */
         ...
         * @member {"nodeUpdate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["nodeUpdate"]),
        ...
        TransactionBody.encode = function encode(m, w) {
            ...
            if (m.nodeUpdate != null && Object.hasOwnProperty.call(m, "nodeUpdate"))
                $root.proto.NodeUpdateTransactionBody.encode(m.nodeUpdate, w.uint32(442).fork()).ldelim();
        ...
        TransactionBody.decode = function decode(r, l) {
            ...
            while (r.pos < c) {
                ...
                case 55: {
                        m.nodeUpdate = $root.proto.NodeUpdateTransactionBody.decode(r, r.uint32());
                        break;
                    }
                case 1001: {
