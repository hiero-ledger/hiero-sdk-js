...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for file updates.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.IFileUpdateTransactionBody|null} [fileUpdate] Modify a file.
         ...
         * @memberof proto
         * @classdesc A transaction body for file updates.
         ...
         * @member {"fileUpdate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["fileUpdate"]),
    ...
    proto.FileUpdateTransactionBody = (function() {
         ...
         * @property {proto.ITimestamp|null} [expirationTime] The new expiry time.
         * @property {proto.IKeyList|null} [keys] The new list of keys that can modify or delete this file.
         * @property {Uint8Array|null} [contents] The new contents that should overwrite the file's current contents.
         * @property {string|null} [memo] If set, the new memo to be associated with the file.
         */

        /**
         * Constructs a new FileUpdateTransactionBody.
         * @memberof proto
         * @classdesc Modify the metadata and/or contents of a file.
        ...
        /**
         * The new list of keys that can modify or delete this file.
        ...
        /**
         * If set, the new memo to be associated with the file.
         * @member {string} memo
         * @memberof proto.FileUpdateTransactionBody
         * @instance
         */
        FileUpdateTransactionBody.prototype.memo = "";
