...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token updates.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenUpdateTransactionBody|null} [tokenUpdate] Update an Hedera token.
         ...
         * @memberof proto
         * @classdesc A transaction body for token updates.
         ...
         * @member {"tokenUpdate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenUpdate"]),
    ...
    proto.TokenUpdateTransactionBody = (function() {
         ...
         * @property {string|null} [symbol] The new publicly visible token symbol.
         * @property {string|null} [name] The new publicly visible name of the token.
         * @property {proto.IAccountID|null} [treasury] The new Treasury account of the Token.
         * @property {proto.IKey|null} [adminKey] The new admin key of the Token.
         * @property {proto.IKey|null} [kycKey] The new KYC key of the Token.
         * @property {proto.IKey|null} [freezeKey] The new Freeze key of the Token.
         * @property {proto.IKey|null} [wipeKey] The new Wipe key of the Token.
         * @property {proto.IKey|null} [supplyKey] The new Supply key of the Token.
         * @property {proto.IAccountID|null} [autoRenewAccount] The new account which will be automatically charged to renew the token's expiration.
         * @property {proto.IDuration|null} [autoRenewPeriod] The new interval at which the auto-renew account will be charged to extend the token's expiry.
         * @property {proto.ITimestamp|null} [expiry] The new expiry time of the token.
         * @property {string|null} [memo] If set, the new memo to be associated with the token.
         * @property {proto.IKey|null} [feeScheduleKey] If set, the new key to use to update the token's custom fee schedule.
         * @property {proto.IKey|null} [pauseKey] If set, the new key that can pause and unpause the Token.
         * @property {Uint8Array|null} [metadata] The new metadata of the token.
         * @property {proto.IKey|null} [metadataKey] The new key which can update the metadata of a token.
         */
         ...
         * @instance
         */
        TokenUpdateTransactionBody.prototype.memo = "";
         ...
         * @instance
         */
        TokenUpdateTransactionBody.prototype.metadata = $util.newBuffer([]);
