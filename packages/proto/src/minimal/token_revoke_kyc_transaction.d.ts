...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for token KYC revoking. */
        ...
        /** A transaction body for token KYC revoking. */
        ...
        /** Revokes KYC to the account for the given token. */
