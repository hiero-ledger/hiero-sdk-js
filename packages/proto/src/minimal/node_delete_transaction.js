...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for node delete.
    ...
    proto.NodeDeleteTransactionBody = (function() {
         ...
         * @constructor
         * @param {proto.INodeDeleteTransactionBody=} [p] Properties to set
         */
         ...
         * @member {Long} nodeId
         * @memberof proto.NodeDeleteTransactionBody
         * @instance
         */
         ...
         * @memberof proto.NodeDeleteTransactionBody
         * @static
         * @param {proto.INodeDeleteTransactionBody=} [properties] Properties to set
         * @returns {proto.NodeDeleteTransactionBody} NodeDeleteTransactionBody instance
         */
        ...
        /**
         * Encodes the specified NodeDeleteTransactionBody message. Does not implicitly {@link proto.NodeDeleteTransactionBody.verify|verify} messages.
         * @function encode
         * @memberof proto.NodeDeleteTransactionBody
         * @static
         * @param {proto.INodeDeleteTransactionBody} m NodeDeleteTransactionBody message or plain object to encode
         * @param {$protobuf.Writer} [w] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {proto.NodeDeleteTransactionBody} NodeDeleteTransactionBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NodeDeleteTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.proto.NodeDeleteTransactionBody();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        NodeDeleteTransactionBody.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.NodeDeleteTransactionBody";
        };
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.INodeDeleteTransactionBody|null} [nodeDelete] Delete a node from the network address book.
         ...
         * @memberof proto
         * @classdesc A transaction body for node delete.
         ...
         * @member {proto.INodeDeleteTransactionBody|null|undefined} nodeDelete
         * @memberof proto.TransactionBody
         * @instance
         */
         ...
         * @member {"nodeDelete"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["nodeDelete"]),
        ...
        TransactionBody.encode = function encode(m, w) {
            ...
            if (m.nodeDelete != null && Object.hasOwnProperty.call(m, "nodeDelete"))
                $root.proto.NodeDeleteTransactionBody.encode(m.nodeDelete, w.uint32(450).fork()).ldelim();
        ...
        TransactionBody.decode = function decode(r, l) {
            ...
            while (r.pos < c) {
                ...
                case 56: {
                        m.nodeDelete = $root.proto.NodeDeleteTransactionBody.decode(r, r.uint32());
                        break;
                    }
                case 1001: {
