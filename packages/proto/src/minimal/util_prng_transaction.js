...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for utility PRNG.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.IUtilPrngTransactionBody|null} [utilPrng] Provide a deterministic pseudorandom number.
         ...
         * @memberof proto
         * @classdesc A transaction body for utility PRNG.
         ...
         * @member {"utilPrng"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["utilPrng"]),
