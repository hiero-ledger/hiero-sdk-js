...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token KYC granting.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenGrantKycTransactionBody|null} [tokenGrantKyc] Grant KYC to an account with respect to a token.
         ...
         * @memberof proto
         * @classdesc A transaction body for token KYC granting.
         ...
         * @member {"tokenGrantKyc"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenGrantKyc"]),
    ...
    proto.TokenGrantKycTransactionBody = (function() {
         ...
         * @property {proto.ITokenID|null} [token] The token for which this account will be granted KYC.
         ...
         * @memberof proto
         * @classdesc Grants KYC to the account for the given token.
