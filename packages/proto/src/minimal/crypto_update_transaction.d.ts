...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for crypto account updates. */
        ...
        /** A transaction body for crypto account updates. */
        class TransactionBody implements ITransactionBody {
            ...
            public data?: "cryptoUpdateAccount";
        ...
        interface ICryptoUpdateTransactionBody {
            ...
            receiverSigRequiredWrapper?: (boolean|null);
        ...
        class CryptoUpdateTransactionBody implements ICryptoUpdateTransactionBody {
            ...
            /** If set to the sentinel value of 0.0.0, this field removes the account's receiver signature requirement. */
            public receiverSigRequiredWrapper: boolean;
