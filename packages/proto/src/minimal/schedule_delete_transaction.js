...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for schedule deletion.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.IScheduleDeleteTransactionBody|null} [scheduleDelete] Delete a schedule.
         ...
         * @memberof proto
         * @classdesc A transaction body for schedule deletion.
         ...
         * @member {"scheduleDelete"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["scheduleDelete"]),
    ...
    proto.ScheduleDeleteTransactionBody = (function() {
         ...
         * @property {proto.IScheduleID|null} [scheduleID] The ID of the Scheduled Entity to be deleted.
         */

        /**
         * Constructs a new ScheduleDeleteTransactionBody.
         * @memberof proto
         * @classdesc Marks a schedule in the network's action queue as deleted, preventing it from executing.
        ...
        /**
         * The ID of the Scheduled Entity to be deleted.
