...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for freeze.
     ...
     * @enum {number}
     * @property {number} UNKNOWN_FREEZE_TYPE=0 An (invalid) default value for this enum.
     * @property {number} FREEZE_ONLY=1 Freezes the network at the specified time.
     * @property {number} PREPARE_UPGRADE=2 Prepares the network for a software upgrade.
     * @property {number} FREEZE_UPGRADE=3 Freezes the network and upgrades software.
     * @property {number} FREEZE_ABORT=4 Aborts a pending network freeze.
     * @property {number} TELEMETRY_UPGRADE=5 Upgrades telemetry.
     */
    ...
    proto.FreezeTransactionBody = (function() {
         ...
         * @property {Uint8Array|null} [fileHash] A SHA384 hash of file content.
         ...
         * @memberof proto
         * @classdesc A transaction body for all freeze transactions.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.IFreezeTransactionBody|null} [freeze] Freeze the network.
         ...
         * @memberof proto
         * @classdesc A transaction body for freeze.
         ...
         * @member {"freeze"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["freeze"]),
