...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for crypto account deletion. */
        ...
        /** A transaction body for crypto account deletion. */
        ...
        /** Mark an account as deleted, transferring its current hbar balance to another account. */
