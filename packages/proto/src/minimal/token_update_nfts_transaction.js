...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token update NFTs.
    ...
    proto.BytesValue = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper for optional bytes values.
        ...
        BytesValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/proto.BytesValue";
        };
    ...
    proto.TokenUpdateNftsTransactionBody = (function() {
         ...
         * @property {proto.IBytesValue|null} [metadata] A new value for the metadata.
         */

        /**
         * Constructs a new TokenUpdateNftsTransactionBody.
         * @memberof proto
         * @classdesc Modify the metadata field for individual non-fungible tokens.
         ...
         * @member {proto.IBytesValue|null|undefined} metadata
         * @memberof proto.TokenUpdateNftsTransactionBody
         * @instance
         */
        ...
        TokenUpdateNftsTransactionBody.encode = function encode(m, w) {
            ...
            if (m.metadata != null && Object.hasOwnProperty.call(m, "metadata"))
                $root.proto.BytesValue.encode(m.metadata, w.uint32(26).fork()).ldelim();
            return w;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenUpdateNftsTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            ...
            while (r.pos < c) {
                ...
                case 3: {
                        m.metadata = $root.proto.BytesValue.decode(r, r.uint32());
                        break;
                    }
                default:
                    r.skipType(t & 7);
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenUpdateNftsTransactionBody|null} [tokenUpdateNfts] Update one or more non-fungible tokens.
         ...
         * @memberof proto
         * @classdesc A transaction body for token update NFTs.
         ...
         * @member {"tokenUpdateNfts"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenUpdateNfts"]),
