...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for crypto allowance deletion.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ICryptoDeleteAllowanceTransactionBody|null} [cryptoDeleteAllowance] Delete one or more approvals for spenders.
         ...
         * @memberof proto
         * @classdesc A transaction body for crypto allowance deletion.
         ...
         * @member {"cryptoDeleteAllowance"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["cryptoDeleteAllowance"]),
    ...
    proto.CryptoDeleteAllowanceTransactionBody = (function() {
         ...
         * @property {Array.<proto.INftRemoveAllowance>|null} [nftAllowances] List of NFT allowances to be deleted.
         */

        /**
         * Constructs a new CryptoDeleteAllowanceTransactionBody.
         * @memberof proto
         * @classdesc Deletes one or more non-fungible approved allowances from an owner's account.
        ...
        CryptoDeleteAllowanceTransactionBody.encode = function encode(m, w) {
            ...
            if (m.nftAllowances != null && m.nftAllowances.length) {
                for (var i = 0; i < m.nftAllowances.length; ++i)
                    $root.proto.NftRemoveAllowance.encode(m.nftAllowances[i], w.uint32(10).fork()).ldelim();
            }
            return w;
        };
    ...
    proto.NftRemoveAllowance = (function() {
         ...
         * @property {Array.<Long>|null} [serialNumbers] List of serial numbers to remove allowances from.
         */

        /**
         * Constructs a new NftRemoveAllowance.
         * @memberof proto
         * @classdesc Nft allowance to be removed on an owner account.
