...
declare namespace hashgraph {
    ...
    namespace proto {
        ...
        /** A wrapper around signed transaction bytes for contract deletion. */
        ...
        /** A transaction body for contract deletion. */
        class TransactionBody implements ITransactionBody {
            ...
            public data?: "contractDeleteInstance";
        ...
        /** Mark a smart contract as deleted, and transfer its remaining hbars to another account. */
