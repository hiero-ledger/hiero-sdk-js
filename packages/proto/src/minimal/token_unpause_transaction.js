...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token unpausing.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for token unpausing.
         ...
         * @member {"tokenUnpause"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenUnpause"]),
    ...
    proto.TokenUnpauseTransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc Unpauses the Token from being paused.
