...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token cancel airdrop.
    ...
    proto.TokenCancelAirdropTransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc Token cancel airdrop - remove pending airdrops from state.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TokenCancelAirdropTransactionBody.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenCancelAirdropTransactionBody|null} [tokenCancelAirdrop] Cancel one or more pending airdrops.
         ...
         * @memberof proto
         * @classdesc A transaction body for token cancel airdrop.
         ...
         * @member {"tokenCancelAirdrop"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenCancelAirdrop"]),
