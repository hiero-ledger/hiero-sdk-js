...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token fee schedule update.
    ...
    proto.TransactionBody = (function() {
         ...
         * @property {proto.ITokenFeeScheduleUpdateTransactionBody|null} [tokenFeeScheduleUpdate] Update the custom fee schedule for a token.
         ...
         * @memberof proto
         * @classdesc A transaction body for token fee schedule update.
         ...
         * @member {"tokenFeeScheduleUpdate"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenFeeScheduleUpdate"]),
