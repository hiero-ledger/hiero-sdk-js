...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for token account unfreezing.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for token account unfreezing.
         ...
         * @member {"tokenUnfreeze"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["tokenUnfreeze"]),
    ...
    proto.TokenUnfreezeAccountTransactionBody = (function() {
         ...
         * @property {proto.ITokenID|null} [token] The token for which this account will be unfrozen.
         ...
         * @memberof proto
         * @classdesc Unfreezes transfers of the specified token for the account.
