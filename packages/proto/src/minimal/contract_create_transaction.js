...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes for contract creation.
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body for contract creation.
         ...
         * @member {"contractCreateInstance"|undefined} data
         * @memberof proto.TransactionBody
         * @instance
         */
        Object.defineProperty(TransactionBody.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["contractCreateInstance"]),
    ...
    proto.ContractCreateTransactionBody = (function() {
         ...
         * @property {proto.IFileID|null} [fileID] The file containing the bytecode for this contract.
         * @property {proto.IKey|null} [adminKey] The admin key for this contract.
         * @property {Long|null} [gas] Gas to be used for this contract creation.
         * @property {Long|null} [initialBalance] Initial balance to be deposited into the contract.
         * @property {proto.IAccountID|null} [proxyAccountID] If the contract requires a proxy account, specify it here.
         * @property {proto.IDuration|null} [autoRenewPeriod] The period that the instance will charge its account every this many seconds.
         * @property {Uint8Array|null} [constructorParameters] The bytes that are the parameters to pass to the constructor.
         * @property {proto.IShardID|null} [shardID] The shard in which this contract is created.
         * @property {proto.IRealmID|null} [realmID] The realm in which this contract is created.
         * @property {proto.IKey|null} [newRealmAdminKey] If realmID is specified, then this the admin key for that realm.
         * @property {string|null} [memo] The memo associated with this contract.
        ...
        ContractCreateTransactionBody.encode = function encode(m, w) {
            ...
            if (m.declineReward != null && Object.hasOwnProperty.call(m, "declineReward"))
                w.uint32(144).bool(m.declineReward);
            return w;
        };
