...
describe("ContractCreateTransaction", function () {
    ...
    describe("complex hook configurations", function () {
        it("should create a hook with LambdaEvmHook and EvmHookSpec", function () {
            ...
            expect(tx.hooks[0].hook.spec.contractId.num.toNumber()).to.equal(
                100,
            );
        });
        ...
        it("should create a hook with LambdaStorageSlot", function () {
            ...
            expect(tx.hooks[0].hook.storageUpdates[0].key).to.deep.equal(key);
        ...
        it("should create a hook with LambdaMappingEntries", function () {
            ...
            expect(tx.hooks[0].hook.storageUpdates[0].entries).to.have.lengthOf(
                1,
            );
            expect(
