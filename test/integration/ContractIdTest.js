...
describe("ContractId", function () {
    ...
    it("should populate contract number from EVM address", async function () {
        ...
        try {
            ...
            const contractEvmAddress = contractId.toEvmAddress();

            // Create another ContractId from the EVM address for testing populateAccountNum
            const idMirror = ContractId.fromEvmAddress(
                0,
                0,
                contractEvmAddress,
            );
